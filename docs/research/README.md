...
| [انحراف VWAP وتركّز الحجم الساعي](vwap_deviation_and_volume_concentration.md) | ❌ مرفوضتان (6 من 6) | ثاني وثالث ميزة من بيانات ساعية حقيقية، نفس البنية المعمارية. `VWAP_DEVIATION`/high: **أقوى نتيجة بين كل الميزات الداخل-يومية** (`mean_ic=+0.081`, `frac_significant=57%`) لكن `consistent_sign=False` يمنع القبول — يستحقّ تشخيصاً إضافياً لاحقاً. `VOL_CONC_HHI` مرفوضة بوضوح في الثلاثة أهداف. |
