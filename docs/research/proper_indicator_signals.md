...
**تأكيد مستقلّ لاحق**: نفس التشخيص أُعيد على ميزة مختلفة تماماً المصدر
(`VWAP_DEVIATION`، من بيانات ساعية حقيقية لا يومية) — **النافذة 24 نفسها
بالضبط** (٢٠٢٢-١١-١٩ إلى ٢٠٢٣-٠١-٢١، ارتداد ما بعد FTX) كسرت اتّساق إشارتها
أيضاً، بالإضافة إلى نوافذ أخرى من فترات ارتداد/صعود حادّ مشابهة. التفاصيل في
[`vwap_deviation_and_volume_concentration.md`§متابعة تشخيصية](vwap_deviation_and_volume_concentration.md#متابعة-تشخيصية-لماذا-ينعكس-اتجاه-vwap_deviationhigh-بين-النوافذ).
هذا يرفع أولوية اختبار فرضية "نظام ارتداد ما بعد الانهيار" بتعريف مباشر (لا
تصنيف نسبي بالزخم فقط) من متوسطة إلى **أعلى**.
